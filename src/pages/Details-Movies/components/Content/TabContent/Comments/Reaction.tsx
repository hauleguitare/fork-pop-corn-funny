...
import { buttonVariants } from './reactionAnimation';
...
const Reaction: React.FunctionComponent<IReactionProps> = (props) => {
  ...
  return (
    <motion.div
      ref={container}
      style={style}
      className="bg-dark-smooth-on-surface py-2 px-4 rounded-lg inline-flex gap-2"
      {...attrs}
    >
      <motion.button
        variants={buttonVariants}
        initial="initial"
        animate={isInView ? 'inView' : 'inHide'}
        whileInView="inViewRotate"
        whileHover="onHover"
        whileTap="onTap"
        transition={{
          duration: 0.1,
