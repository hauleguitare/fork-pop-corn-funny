...
const ProfileAvatar: React.FunctionComponent<IProfileAvatarProps> = (props) => {
  ...
  return (
    <div className="w-24 h-24 font-roboto rounded-full inline-block overflow-hidden absolute -translate-y-1/2 up-mobile:left-4 left-2 border-2 border-dark-smooth-on-surface group">
      <img
